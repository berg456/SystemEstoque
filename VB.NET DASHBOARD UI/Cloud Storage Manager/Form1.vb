Public Class Form1
    ...
    Private Sub recentfiles()
        ...
        Guna2DataGridView1.Rows(0).Cells(0).Value = Image.FromFile("img\\microsoft_word.png")
        ...
        Guna2DataGridView1.Rows(1).Cells(0).Value = Image.FromFile("img\\microsoft_word.png")
